...
<div class="max-w-7xl mx-auto px-4">
  <div class="flex flex-col md:flex-row gap-6 justify-center items-start">
    ...
    <div class="max-w-md mx-auto mt-5">
          <div class="relative bg-white rounded-2xl shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
              
              <!-- TÍTULO: DOCUMENTACIÓN -->
              <div class="absolute -top-5 left-1/2 transform -translate-x-1/2 z-10">
                  <div class="px-6 py-1 rounded-full text-sm font-bold text-white shadow-xl border border-gray-300
                              bg-yellow-600
                              ring-4 ring-white ring-offset-2 ring-offset-yellow-600
                              drop-shadow-md hover:scale-105 transition-all duration-300">
                      Documentación
                  </div>
              </div>
              ...
              <div class="p-6 pt-10 text-center">
                  <!-- Ícono de documento -->
                  <div class="flex justify-center mb-4">
                      <div class="bg-yellow-100 text-yellow-600 rounded-full p-4 shadow-inner">
                          <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none"
                              viewBox="0 0 24 24" stroke="currentColor">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  ...
                  <!-- Descripción -->
                  <h3 class="text-xl font-bold text-gray-800 mb-2">Documentos en revisión</h3>
                  <p class="text-gray-500 text-sm mb-4">
                      Hemos recibido tus archivos, se están validando por el equipo.
                  </p>
                  ...
                  <!-- Botón de acción -->
                  <button class="mt-2 bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-sm transition-all duration-200">
                      Subir documentos
                  </button>
              </div>
          </div>
    ...
    <div class="max-w-md mx-auto mt-5">
          <div class="relative bg-white rounded-2xl shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow duration-300 ease-in-out">
              ...
              <div class="absolute -top-5 left-1/2 transform -translate-x-1/2 z-10">
                  <div class="px-6 py-1 rounded-full text-sm font-bold text-white shadow-xl border border-gray-300
                              bg-red-600
                              ring-4 ring-white ring-offset-2 ring-offset-red-600
                              drop-shadow-md hover:scale-105 transition-all duration-300">
                      Pago
                  </div>
              </div>
              ...
              <div class="p-6 pt-10 text-center">
                  ...
                  <!-- Descripción -->
                  <h3 class="text-xl font-bold text-gray-800 mb-2">Pago pendiente</h3>
                  <p class="text-gray-500 text-sm mb-4">
                  ...
                  <!-- Botón de acción -->
                  <button class="mt-2 bg-red-600 hover:bg-red-700 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-sm transition-all duration-200">
                      Realizar pago
                  </button>
              </div>
          </div>
