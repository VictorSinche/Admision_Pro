<div class="modalidad-tab" data-mod="L">
                ...
                <tbody>
                    @foreach($postulantesModalidad as $i => $postulante)
                        <tr data-dni="{{ $postulante->c_numdoc }}">
                            ...
                            <td class="p-4 border-b border-slate-200 text-center" data-estado="{{ $verif->certprofesional ?? 'null' }}" data-campo="certprofesional">
                                {!! mostrarIconoVerificacion($verif->certprofesional ?? null) !!}
                            </td>
