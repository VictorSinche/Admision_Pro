...
@else
  {{-- Si no completó documentos --}}
  @if ($declaracionExiste)
    {{-- ✅ Ya tiene DJ --}}
    <div class="mt-6 bg-green-100 border-l-4 border-green-600 text-green-800 p-4 rounded-lg shadow-sm">
      <div class="flex items-start">
        <i class="fa-solid fa-circle-check text-green-600 mt-1 mr-3"></i>
        <div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        @if ($fechaLimite && !$documentosCompletos)
            Swal.fire({
      ...
      @if (session('documentos_incompletos'))
          @if ($declaracionExiste)
              Swal.fire({
                  ...
                  html: `
                      <p>Ya presentaste tu <strong>declaración jurada</strong>.</p>
                      <p>Puedes seguir subiendo documentos hasta la fecha límite:</p>
                      <br>
