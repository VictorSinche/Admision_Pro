...
<body>
    ...
    {{-- <script>
        $(document).ready(function () {
            ...
            { id: 'constancia_colegio', texto: 'Constancia o resolución original del director del colegio de procedencia que acredite el orden de mérito requerido. (debe haber egresado los dos últimos años inmediatos a la fecha de admisión).' },
        ...
        $('.btnGuardarDeclaracion').on('click', function () {            
            ...
            let formData = {
                ...
                constancia_colegio:   getDocValue('constancia_colegio'),
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('administrativo.admision.guardarDeclaracionPP') }}",
                data: formData,
                headers: {
