                ...
                <ul class="list-unstyled">
                    @php
                        $campos = [
                            ...
                            'constancia_colegio' => 'Constancia original del director del colegio de procedencia que acredite el promedio de 14 del tercero al quinto de secundaria. (debe haber egresado los dos últimos años inmediatos a la fecha de admisión).',
